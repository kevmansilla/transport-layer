...
# Cargo base
data = pandas.read_csv('caso2_1.csv')
print(data)
print(data.columns)
...
ax2.plot(42, 200, marker="o", color="blue", label='(42,200)')
plt.legend()
ax2.set_title('Queue')
...
plt.suptitle("Caso 2 (generationInterval = 0.1): Paquetes enviados y recibidos")
sns.barplot(
